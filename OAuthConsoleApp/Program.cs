...
namespace OAuthConsoleApp
{
    class Program
    {
        ...
        const string clientID = "898292369310-slgeq5avg6km7q0jncs89rd4ij28ra5l.apps.googleusercontent.com";
        const string clientSecret = "UeZ5MJK2a75KiF1XUyIXpSfp";
        ...
        private async void doOAuth()
        {
            ...
            string redirectURI = string.Format("http://{0}:{1}/", IPAddress.Loopback, /*GetRandomUnusedPort()*/8080);
